...
def metric_from_state(
    state: dict[str, Any], expected_route: str, approval_required: bool  # noqa: ANN401
) -> ScenarioMetric:
    ...
    has_ans = bool(state.get("final_answer") or state.get("pending_question"))
    success = (actual_route == expected_route) and has_ans
