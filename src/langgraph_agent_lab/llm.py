...
def get_llm(model: str | None = None, temperature: float = 0.0) -> Any:  # noqa: ANN401
    ...
    if os.getenv("GEMINI_API_KEY"):
        ...
        model_google = model or os.getenv("LLM_MODEL") or "gemini-2.5-flash"
    ...
    if os.getenv("OPENAI_API_KEY"):
        ...
        model_openai = model or os.getenv("LLM_MODEL") or "gpt-4o-mini"
        return ChatOpenAI(
            model=model_openai,
            temperature=temperature,
        )
    ...
    if os.getenv("ANTHROPIC_API_KEY"):
        ...
        model_anthropic = model or os.getenv("LLM_MODEL") or "claude-sonnet-4-20250514"
